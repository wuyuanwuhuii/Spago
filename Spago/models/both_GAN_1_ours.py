...
class VGAEEncoder(nn.Module):
    def __init__(self, in_channels, hidden_channels, latent_channels, spatial_coord_dim=2, dropout_rate=0, K= 3):
        ...
        self.conv1 = TransformerConv(512,hidden_channels)
        self.bn1 = nn.BatchNorm1d(128)
        self.conv2 = TransformerConv(256,hidden_channels)
        self.bn2 = nn.BatchNorm1d(hidden_channels)
        self.conv3 = TransformerConv(128,hidden_channels)
        self.fusion_layer = nn.Linear(in_channels + spatial_coord_dim, in_channels + spatial_coord_dim)
        
        
        self.conv_mu = TransformerConv(hidden_channels, latent_channels)
        self.conv_logstd = TransformerConv(hidden_channels, latent_channels)
...
class VGAEEncoder_atac(nn.Module):
    def __init__(self, in_channels, hidden_channels, latent_channels, spatial_coord_dim=2, dropout_rate=0, K=3):
        ...
        self.conv2 = GATConv(128, hidden_channels)
        self.conv3 = GATConv(256, hidden_channels)
        ...
        self.conv_mu = GATConv(hidden_channels, latent_channels)
        self.conv_logstd = GATConv(hidden_channels, latent_channels)
