...
def main():
    ...
    genes_to_zero_check = cross_val_splits[4][1] # 0 1 2 3
    ...
    genes_to_zero = cross_val_splits[4][1]
    ...
    hidden_channels = 128 #  128  48
    latent_channels = 64#  64   64
    
    hidden_channels_2 = 128  # 128  32 64
