...
def main():
    ...
    sc_rna_train_dataset=ad.read_h5ad('/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_rna.h5ad')
    sc_atac_train_dataset=ad.read_h5ad('/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_atac.h5ad')
    sc_rna_test_dataset=ad.read_h5ad('/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_rna.h5ad')
    sc_atac_test_dataset=ad.read_h5ad('/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_atac.h5ad')
    sc_rna_dataset=ad.read_h5ad('/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_rna.h5ad')
    sc_atac_dataset=ad.read_h5ad('/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_atac.h5ad')
    
    #sc.pp.normalize_total(sc_rna_train_dataset, )
    #sc.pp.log1p(sc_rna_train_dataset)
    #sc_rna_train_dataset.var_names_make_unique()
    
    #sc.pp.normalize_total(sc_rna_test_dataset, )
    #sc.pp.log1p(sc_rna_test_dataset)
    #sc_rna_test_dataset.var_names_make_unique()
    
    #sc_atac_train_dataset.X[sc_atac_train_dataset.X > 0] = 1 
    #sc_atac_test_dataset.X[sc_atac_test_dataset.X > 0] = 1 
    #sc_atac_dataset.X[sc_atac_dataset.X > 0] = 1 
...
# Model
    ...
    for h_dim, lr, rand_seed in param_combos:
        ...
        def predict_atac_2(truth,generator,truth_iter):
            logging.info("....................................Evaluating ATAC ")
            def predict1(generator,truth_iter):
                generator.eval()
                first = 1
                if hasattr(truth_iter.X, 'toarray'):  
                    x = torch.tensor(truth_iter.X.toarray(), dtype=torch.float32).to('cuda:0')
                else:
                    x = truth_iter.X.to('cuda:0')  
        ...
        def predict_rna_2(truth,generator,truth_iter):
            logging.info(".........................................Evaluating  RNA")
...
#csr matrix to tensor
        device='cuda:0'
        #sc_atac_train_dataset.X = torch.tensor(sc_atac_train_dataset.X.toarray()).to(device)
        #sc_rna_train_dataset.X = torch.tensor(sc_rna_train_dataset.X.toarray()).to(device)

        #generatorRNA.load_state_dict(torch.load(os.path.join(outdir_name, "RNAgenerator.pth")))
        #generatorRNA.to(device)
        #predict_rna_2(sc_rna_train_dataset.X, generatorRNA, sc_atac_train_dataset)
        #generatorATAC.load_state_dict(torch.load(os.path.join(outdir_name, "ATACgenerator.pth")))
        #generatorATAC.to(device)
        #predict_atac_2(sc_atac_train_dataset.X, generatorATAC, sc_rna_train_dataset)
        #dsddddd
        ...
        sc_atac_truth_dataset = ad.read_h5ad('/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_atac.h5ad')
        #sc_atac_truth_dataset.X[sc_atac_truth_dataset.X > 0] = 1 
        print("sc_atac_truth_dataset")
        print(sc_atac_truth_dataset)
        sc_atac_truth_dataset.X = sparse.coo_matrix(sc_atac_truth_dataset.X)  
        ...
        sc_rna_truth_dataset = ad.read_h5ad('/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_rna.h5ad')
        #sc_rna_truth_dataset.var_names_make_unique()
        #sc.pp.normalize_total(sc_rna_truth_dataset, )
        #sc.pp.log1p(sc_rna_truth_dataset)
        sc_rna_truth_dataset.X = sparse.coo_matrix(sc_rna_truth_dataset.X)
