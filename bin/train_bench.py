...
def predict_rna(truth,generator,truth_iter, outdir_name, rna2atac, atac2rna):
...
def main():
    ...
    # 3.
    sc.pp.highly_variable_genes(sc_atac_train_dataset_copy, n_top_genes=3000)
    ...
    train_rna_s.write_h5ad("/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_rna.h5ad")
    train_atac_s.write_h5ad("/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/train_atac.h5ad")
    test_rna_s.write_h5ad("/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/truth_rna.h5ad")
    test_atac_s.write_h5ad("/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/truth_atac.h5ad")
    valid_rna_s.write_h5ad("/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/valid_rna.h5ad")
    valid_atac_s.write_h5ad("/mnt/datab/home/zhaohui/WBT/scMOG-main/scMOG_code/mouse_mebryo/valid_atac.h5ad")
            ...
            for epoch in range(num_epochs):
                ...
                for i in range(1):
                    ...
                    if ISRNA:
                        ...
                        loss_A = rna_recon_cycle_loss #+ rna_rna_recon_loss * 10 #+ 0.01 * (cycle_loss_rna) + rna_recon_cycle_loss_train # 10 + reg_loss_rna * 0.01 + lambda_cycle * (cycle_loss_rna )#+ cycle_loss_atac) # + kl_rna
                    else :
                ...
                if ((epoch + 1) % 10== 0):
                    if ISRNA:
                        ...
                        predict_rna(truth, generator_B, valid_atac, outdir_name,  rna2atac, atac2rna)
                    else:
                ...
                if test_iter:
                    ...
                    with torch.no_grad():
                        ...
                        if ISRNA:
                            ...
                            loss_test = rna_recon_cycle_loss_test #+ rna_rna_recon_loss_test * 10 # + 0.01 * (cycle_loss_rna_test) + rna_recon_cycle_loss_test_2  #* 10 + reg_loss_rna * 0.01 + lambda_cycle * (cycle_loss_rna ) #  + kl_rna
                        else :
